...
exports._match_docs = function (db, docs, callback, ref_fields) {
    log("match docs");
...
// update ref id for a set of docs 
// call callback(docs, changed_docs)
exports.match_docs = function (db, docs, callback) {
    log("match docs");
    ...
    db.allDocs({
        ...
        var mms = data.rows.map(function (r) {
            return r.doc;
        });
        // get ref_fields
        var ref_fields = MM.get_ref_fields_mms(mms);
        
        exports._match_docs(db, docs, callback, ref_fields);
    });
