function(callback, e, id, new_doc, trigger) {
    ...
    function loadSliderLib() {
        $.getScript('vendor/html5slider/html5slider.min.js', function() {
            loadSliderLibOk = true;
            next();
        });
    }
    ...
    function next() {
        ...
        if (loadDocOk && loadSynLabelOk
            ...
            && (needSliderLib === false || (needSliderLib && loadSliderLibOk))) {
