    ...
    db.openDoc(id, { 
        ...
        success: function(doc) {
            if (doc._conflicts) {
                ...
                if (! mm) { // structure was not in cache... probably the design doc is not in the database
                    utilsLib.showError('Could not find structure for "' + doc.$label + '" - orphan document?');
                    callback(id, null, null, null);
                }
                if (!mm.isref) {
