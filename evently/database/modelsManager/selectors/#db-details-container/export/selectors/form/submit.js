function() {
    var app = $$(this).app,
        ...
        label_field = $('input[name="label-field"]', this).attr('checked') ? true : false,
        id_field = $('input[name="id-field"]', this).attr('checked') ? true : false;
    ...
    app.db.openDoc(mmId, {
        success: function(mm) {
            ...
            var url = '_list/all2csv/export'
                ...
                + '&include_label='
                + encodeURIComponent(label_field)
                + '&include_id='
                + encodeURIComponent(id_field)
                + '&fn=' + filename + '.csv';
