...
// @TODO rewrite / redesign everything: even Chuck Norris can't understand that code

// get viewTable data for a filter (query)
...
// displays a mm
exports.mm_async = function(app, mm, modi, sort_params, skip, limit, showSyn, callback) {
    ...
    Query.lucene_query(app.db, proc_res, q, skip, limit, true, sort_params);
};
